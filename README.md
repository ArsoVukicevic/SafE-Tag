...
Compared to the original study - this implementation is extended with new features, and the backend was reimplemented using the PHP programming language (thanks to the engagement of https://github.com/mujan).
